...
To set up SCIM, use one of the following options based on your organization’s configuration:
  ...
  * **First-time setup:** If you are setting up SCIM with HackerRank for the first time, follow the [_Setting Up SCIM Provisioning for SkillUp_](<https://support.hackerrank.com/articles/9005750838-setting-up-scim-provisioning-for-skillup?lang=en>) article.
