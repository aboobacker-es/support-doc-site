...
---|---|---  
A & C| 5| Both correct answers selected.   
2.5 + 2.5 = 5  
A & B| 2| One correct (A = 2.5) and one incorrect (B = -0.5).   
2.5 - 0.5 = 2  
A & D| 2| One correct (A = 2.5) and one incorrect (D = -0.5).   
2.5 - 0.5 = 2  
B & C| 2| One correct (C = 2.5) and one incorrect (B = -0.5).   
2.5 - 0.5 = 2  
C & D| 2| One correct (C = 2.5) and one incorrect (D = -0.5).   
2.5 - 0.5 = 2  
B & D| -1| Both selections are incorrect.   
-0.5 - 0.5 = -1  
A, B, & C| -1| Three options selected (more than 2 correct answers). System assigns -1  
B, C, & D| -1| Three options selected (more than 2 correct answers). System assigns -1  
C, D, & A| -1| Three options selected (more than 2 correct answers). System assigns -1  
A, B, C, & D| -1| Four options selected (more than 2 correct answers). System assigns -1
