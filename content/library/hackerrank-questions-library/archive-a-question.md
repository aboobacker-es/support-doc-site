...
:::note
You can unarchive multiple questions at once. You can unarchive multiple test questions at once. From the archived questions filter, select the checkboxes next to the tests and click **Restore**.
:::
