...
:::
  ...
  * **Inline Hints:** Display contextual information directly in the editor without modifying the actual source code. For example, a hint such as `initialValue:` may appear before an argument to indicate the associated function parameter.

  * **Code Lens:** Displays actionable metadata near code elements. For example, Run, Debug, References, or test-related actions. Click a Code Lens item to access symbol-specific actions or insights.​ ​​
