...
**Prerequisites**
  ...
  * An Active Integration with Greenhouse - or you can set it up from here:[📄 Greenhouse - HackerRank Integration](</docs/3147b674-5cbb-4bde-9528-7699bb64b1a7/articles/c7501ce6-f3d7-43a2-ace7-f3ab7ffa15ce>)
...
#### For Public Link
  ...
  * Refer to the[📄 Modifying Test Access Settings](</docs/3147b674-5cbb-4bde-9528-7699bb64b1a7/articles/fd2099d7-31fb-42f5-b5e9-d8365b0cef4f>)article to create a public test URL in case your test does not have one.
...
You can enable Public Link for specific tests from “Test Settings” by following this document:[📄 Modifying Test Access Settings](</docs/3147b674-5cbb-4bde-9528-7699bb64b1a7/articles/fd2099d7-31fb-42f5-b5e9-d8365b0cef4f>)
