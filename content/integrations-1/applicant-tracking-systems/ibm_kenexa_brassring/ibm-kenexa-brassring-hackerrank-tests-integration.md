...
slug: /integrations-1/applicant-tracking-systems/ibm_kenexa_brassring/ibm-kenexa-brassring-hackerrank-tests-integration
pylon_id: bc45145f-dc49-410b-b1a6-3c7e8c7cf877
published_url: https://support.hackerrank.com/articles/7795424803-IBM-Kenexa-BrassRing---HackerRank-Tests-Integration
...
HACKERRANKTESTID| Varchar| This is the Test ID of the test that should be sent to the candidate. For example, the Test ID for the following test URL is 454785: <https://www.hackerrank.com/work/tests/454785/questions>  
...
Field Name | Note  
---|---  
Assessment Name| This is the candidate email address. HackerRank will send the invitation email.   
First Name| Candidate First Name.   
Last Name| Candidate Last Name.   
Percentage| This is the percentage score for the candidate  
Requisition ID| This is the Requisition number. It will match the BRREQNUMBER from the Candidate Export.   
Date of Assessment| This is the date of the assessment  
Link to Assessment Summary| This is a link back to the test results in HackerRank  
Overall Score| This is the score, in points.   
Assessment Code/ID| This is the test that was taken.   
Candidate Status|   
