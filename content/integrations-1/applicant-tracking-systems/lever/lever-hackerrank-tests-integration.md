...
slug: /integrations-1/applicant-tracking-systems/lever/lever-hackerrank-tests-integration
pylon_id: 3d334428-956d-47ea-9992-a4b609bb67e0
published_url: https://support.hackerrank.com/articles/7177093032-Lever---HackerRank-Tests-Integration
...
_Enabling the "HackerRank Tests" integration in Lever_
  ...
  3. In the **Access token** field, add the API key obtained from HackerRank for Work.

  4. Click on the **Verify** button to test the authentication request between Lever and HackerRank. Verification should be successful.
...
_The 'HackerRank' assignment form for different interview stages in Lever_
...
_The 'Send Test' option is displayed when the Candidate pipeline stage is changed._
...
_Sending a HackerRank Test invite in Lever_
...
_The Candidate's HackerRank Test report is updated in Lever_
