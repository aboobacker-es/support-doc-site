...
slug: /integrations-1/single-sign-on-sso/setting-up-hackerrank-sso-with-just-in-time
pylon_id: fc66638e-ffb0-4a43-a4c4-fe3f9d10f391
published_url: https://support.hackerrank.com/articles/8000473667-Just-in-Time-(JIT)-Provisioning-for-HackerRank-SSO
...
For JIT provisioning to work correctly, the IdP must include the following user attributes in the SAML response:
  ...
  * **Groups** _(optional):_ Details such as user roles or departments. Used for organizing or assigning roles.
...
To configure:
  ...
  1. Log in to the [_AWS IAM Identity Center_](<https://aws.amazon.com/iam/identity-center/>).
...
To configure:
  ...
  1. Log in to the [_Azure Portal_](<https://portal.azure.com>).
...
To configure:
  ...
  1. Log in to the [_Google Admin_](<https://admin.google.com/>) console.
...
If you need further assistance, contact us at [_support@hackerrank.com_](<mailto:support@hackerrank.com>).
