...
To set up Optimality Evaluation:
  ...
  1. Enable **Advanced Evaluation**. For more information, see [_Enable Advanced Evaluation_](<https://support.hackerrank.com/articles/7098008997-advanced-evaluation#enable-advanced-evaluation-6>).
