...
Login concurrency has also increased from 100 to 1,000 users per minute, allowing even the largest campus drives to run as a single event. For greater scale needs, reach out to your account manager or [support@hackerrank.com](<mailto:support@hackerrank.com>).
...
Sign up for access to [_AI Interviewer_](<https://www.hackerrank.com/products/ai-interviewer>), or reach out to your account manager for more details.
